...
export namespace FixmypicGraphTypes {
  ...
  export type SubscriptionSdk = {
    ...
    /** null **/
    requestSubmission: InContextSdkMethod<
      Subscription['requestSubmission'],
      SubscriptionrequestSubmissionArgs,
      MeshContext
    >;
    /** null **/
    requestSubmissions: InContextSdkMethod<
      Subscription['requestSubmissions'],
      SubscriptionrequestSubmissionsArgs,
      MeshContext
    >;
    /** null **/
    submissionPurchase: InContextSdkMethod<
      Subscription['submissionPurchase'],
      SubscriptionsubmissionPurchaseArgs,
      MeshContext
    >;
    /** null **/
    submissionPurchases: InContextSdkMethod<
      Subscription['submissionPurchases'],
      SubscriptionsubmissionPurchasesArgs,
      MeshContext
    >;
    /** Access to subgraph metadata **/
